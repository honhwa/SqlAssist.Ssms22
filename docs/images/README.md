...
插畫來源與可重製提示詞見下節；`completion.png`、`structure-preview.png` 與結果格線
圖片則是實機畫面或標註後的實機畫面。

## 生成提示詞

影像模型較能準確理解英文描述，因此提示詞保留英文；插畫一律避免可讀文字，文案應留在
HTML／Markdown，才能翻譯並讓螢幕閱讀器讀取。
